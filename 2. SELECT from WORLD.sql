...
SELECT name, continent, population 
 ...
 #2. Show the name of the countries that have a population of at least 200 million. 200 million is 200000000, there are eight zeros.
...
#4. Show the name and population in millions of the countries of the continent 'South America'. 

SELECT name, population/1000000
 FROM world
  WHERE continent =  'South America'
  
#5. Show the name and population of France, Germany, Italy
